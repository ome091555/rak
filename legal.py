...
<h2>第2条（利用登録）</h2>
<ul>
<li>利用者は、運営者の定める方法により利用登録を行うものとします。</li>
...
<h2>1. 取得する情報</h2>
<ul>
<li>利用者・チームメンバーの氏名、チーム情報、連絡事項、スケジュール、集金・会計等の入力情報</li>
...
<li>本サービスはセッション維持のために Cookie（サーバーサイドセッション）を使用します。広告目的のサードパーティ Cookie は使用していません。</li>
</ul>
...
<h2>6. 未成年者の個人情報</h2>
<p>本サービスは少年野球・少年サッカー等のジュニアスポーツチームでの利用を想定しており、未成年者の個人情報が入力される場合があります。未成年者が本サービスを利用する場合は、保護者の同意を得た上で利用してください。チームの管理者（保護者含む）は、メンバーの氏名等を入力する前に本人・保護者の同意を確認してください。未成年者に関する個人情報の開示・訂正・削除の請求は、保護者からも受け付けます。</p>
