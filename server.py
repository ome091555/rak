...
# App Store（2026-08-19 審査承認・配信開始）
APP_STORE_URL = 'https://apps.apple.com/jp/app/id6781234648'
APP_STORE_BADGE = '/assets/appstore-badge.svg'
# Apple公式バッジ（日本語・黒）。外部読み込みを避けて自前配信する
APP_STORE_BADGE_SVG = '''<svg id="JP" xmlns="http://www.w3.org/2000/svg" width="108.85157" height="40" viewBox="0 0 108.85157 40">
  ...
  <div class="hero-inner">
    <div class="hero-l">
      ...
      <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-top:14px">
        <a href="{APP_STORE_URL}" target="_blank" rel="noopener" aria-label="App Storeでダウンロード" style="display:inline-block;line-height:0">
          <img src="{APP_STORE_BADGE}" alt="App Storeでダウンロード" height="44" style="height:44px;width:auto;display:block">
        </a>
        <span style="font-size:12px;color:#6b7280;line-height:1.6">iPhoneアプリを公開しました<br>ブラウザでもそのまま使えます</span>
      </div>
    </div>
    <div class="hero-r">
...
<section class="features" id="features">
  <div style="max-width:900px;margin:0 auto">
    ...
    <div style="max-width:880px;margin:48px auto 0;text-align:center">
      <span class="sec-label">PRO FEATURES</span>
      <div class="sec-title" style="margin-top:6px">Proでできること、<br>中身を見せます。</div>
...
<section class="cta-sec">
  ...
  <div style="margin-top:20px">
    <a href="{APP_STORE_URL}" target="_blank" rel="noopener" aria-label="App Storeでダウンロード" style="display:inline-block;line-height:0">
      <img src="{APP_STORE_BADGE}" alt="App Storeでダウンロード" height="44" style="height:44px;width:auto;display:block;margin:0 auto">
    </a>
  </div>
</section>
...
<footer>
  ...
  <div class="footer-links">
    ...
    <a href="{APP_STORE_URL}" target="_blank" rel="noopener">iOSアプリ</a>
  </div>
  <p>© 2026 Rak</p>
</footer>
{PWA_SW}
